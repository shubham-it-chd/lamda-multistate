output "lambda_function_arn" {
  ...
  value       = module.lambda_sample_one.lambda_function_arn
}

output "lambda_function_name" {
  description = "Name of the Lambda function"
  value       = module.lambda_sample_one.lambda_function_name
}

output "lambda_function_invoke_arn" {
  description = "Invoke ARN of the Lambda function"
  value       = module.lambda_sample_one.lambda_function_invoke_arn
}

output "cloudwatch_log_group_name" {
  description = "Name of the CloudWatch log group"
  value       = module.lambda_sample_one.cloudwatch_log_group_name
}

output "lambda_package_type" {
  description = "Package type used for the Lambda function"
  value       = module.lambda_sample_one.lambda_package_type
}

output "lambda_image_uri" {
  description = "Image URI used by the Lambda function when package_type=Image"
  value       = module.lambda_sample_one.lambda_image_uri
}
